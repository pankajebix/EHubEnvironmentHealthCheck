...
public class LoginPage {
	...
	@FindBys(@FindBy(xpath = "//div/input[@id='mat-input-0']/parent::div/label"))
	private WebElement useridLabel;

	@FindBys(@FindBy(xpath = "//div/input[@id='mat-input-1']/parent::div/label"))
	...
	public void doLogin(String loginUsername, String loginPassword) {
		try {
			...
			log.info("Enter Username : "+"XXXXX");
			BaseClass.logExtentReport("Enter Username : "+"XXXXX");
			
			eleUtil.waitForElementVisibleAndToBeClickable(password, AppConstants.DEFAULT_LONG_TIME_OUT);
			password.clear();
			password.sendKeys(loginPassword);
			log.info("Enter Password : "+"XXXXX");
			BaseClass.logExtentReport("Enter Password : "+"XXXXX");
