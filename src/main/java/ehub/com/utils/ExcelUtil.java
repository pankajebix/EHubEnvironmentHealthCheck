...
public class ExcelUtil {
	...
	public void fillBackgroundCellColorWhite(String sheetName, int rowNumber, int columnNumber) {
		try {
			fis = new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);
			sheet = workbook.getSheet(sheetName);
			...
			System.err.println("Issue in ExcelUtil.fillBackgroundCellColorWhite "+e);
		}
	}
