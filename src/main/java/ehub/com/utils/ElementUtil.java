...
public class ElementUtil {
	...
	public WebElement waitForElementToBeClickableStaleElementReferenceException(int timeOut, WebElement ele) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
		return wait.ignoring(StaleElementReferenceException.class).until(ExpectedConditions.elementToBeClickable(ele));
	}
	...
	public void waitForElementVisibleAndToBeClickableStaleElementReferenceException(WebElement ele, int timeOut) {
		waitForElementVisible(ele, timeOut);
		waitForElementToBeClickableStaleElementReferenceException(timeOut, ele);
	}
	...
	public void retryingFindClick(WebElement ele, int attemptsCount) {
		int attempts = 0;
		while (attempts < attemptsCount) {
			try {
				ele.click();
	...
	/**
	 * Perform Select All using Ctrl + A
	 */
	public void selectAllCtrlPlusA() {
	...
	/**
	 * Perform Copy using Ctrl + C
	 */
	public void copyCtrlPlusC() {
		Actions actions = new Actions(driver);
		actions.keyDown(Keys.CONTROL);
		actions.sendKeys("c");
		actions.keyUp(Keys.CONTROL);
	...
	/**
	 * Perform Paste using Ctrl + V
	 */
	public void pasteCtrlPlusV() {
