...
public class BaseClass {
	...
	public WebDriver initilization(String urll) {
...
//		optionsEdge.addArguments("--remote-allow-origins=*");
		...
		//String url=PropertyUtility.getPropertyEnvironment("url");
		String url=urll;
		getDriver().get(url);
...
//		//ExcelUtil excUtil = new ExcelUtil(System.getProperty("user.dir") + PropertyUtility.getProperty("pathofExcelTestData"));
//		//String name = excUtil.getCellData("chooseTestEnvironment", "chooseTestEnvironment", 2);
//		String name = PropertyUtility.getPropertyEnvironment("environment");
//
//		if (name.equalsIgnoreCase("test")) {
//			excelName = "\\src\\test\\resources\\testData\\testDataForTestEnvironment.xlsx";
//
//		} else if (name.equalsIgnoreCase("testv2")) {
//			excelName = "\\src\\test\\resources\\testData\\testDataForTestV2Environment.xlsx";
//
//		} else if (name.equalsIgnoreCase("poc3")) {
//			excelName = "\\src\\test\\resources\\testData\\testDataForPOC3Environment.xlsx";
//
...
//			SendEmail.main(null);
//		}
		if (PropertyUtility.getPropertyEnvironment("sendEmail").trim().equalsIgnoreCase("yes")) {
			SendEmail.main(null);
		}
	}
}
