...
public class POC_1_EnvironmentCheckPageTest extends BaseTest{
	...
	public void setupBrowser() {
		String url=PropertyUtility.getPropertyEnvironment("POC_1_Env_URL").trim();
		setup(url);
	...
	public void POC_1_Env_doLogin() {
		BaseClass.logExtentReport("Enter URL : "+ PropertyUtility.getPropertyEnvironment("POC_1_Env_URL").trim());
		loginPage.doLogin(AppConstants.username, AppConstants.password);		
	}
	
	@Test(priority = 2, enabled = true)
	public void POC_1_Env_verifyUserLogin() {
