...
public class Perf_EnvironmentCheckPageTest extends BaseTest{
	...
	public void setupBrowser() {
		String url=PropertyUtility.getPropertyEnvironment("Perf_Env_URL").trim();
		setup(url);
	...
	public void Perf_Env_doLogin() {
		BaseClass.logExtentReport("Enter URL : "+ PropertyUtility.getPropertyEnvironment("Perf_Env_URL").trim());
		loginPage.doLogin(AppConstants.username, AppConstants.password);		
	}
	
	@Test(priority = 2, enabled = true)
	public void Perf_Env_verifyUserLogin() {
