...
public class Test_EnvironmentCheckPageTest extends BaseTest{
	...
	public void setupBrowser() {
		String url=PropertyUtility.getPropertyEnvironment("Test_Env_URL").trim();
		setup(url);
	...
	public void Test_Env_doLogin() {
		BaseClass.logExtentReport("Enter URL : "+ PropertyUtility.getPropertyEnvironment("Test_Env_URL").trim());
		loginPage.doLogin(AppConstants.username, AppConstants.password);		
	}
	
	@Test(priority = 2, enabled = true)
	public void Test_Env_verifyUserLogin() {
